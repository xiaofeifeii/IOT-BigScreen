          ...
          <div class="inner_right">
            ...
            <div class="flex">
              ...
              <div class="info addresswrap" >
                ...
                <span class="contents " style="font-size: 14px">
                  {{ item.CreateTime }}</span
                >
              </div>
              <div class="info addresswrap" >
                <span class="labels">雾灯模式：</span>
                <span class="contents ciyao" style="font-size: 14px">
                  {{ item.Light_mode }}</span
                >
              </div>
              
              <div class="info addresswrap">
              
                <span class="labels ">雾灯频率：</span>
                <span class="contents ciyao" style="font-size: 14px">
                  {{ item.Light_freq }}</span
                >
                <span class="labels">雾灯亮度：</span>
                <span class="contents ciyao" style="font-size: 14px">
                  {{ item.Lightness }}</span  
                >
              </div>
              ...
              <div class="info addresswrap">
                <span class="labels">信号强度：</span>
                <span class="contents ciyao" style="font-size: 14px">
                  {{ item.Signal }}</span
                >
                <span class="labels">电压值：</span>
                <span class="contents ciyao" style="font-size: 14px">
                  {{ item.Voltage }}</span
                >
              </div>
